...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cnet: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cnet ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Extras/QuantumHomer.o: Extras/QuantumHomer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Extras
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Extras/QuantumHomer.o Extras/QuantumHomer.cpp

${OBJECTDIR}/Extras/Spi.o: Extras/Spi.cpp 
	${MKDIR} -p ${OBJECTDIR}/Extras
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Extras/Spi.o Extras/Spi.cpp

${OBJECTDIR}/Libraries/LibJson.o: Libraries/LibJson.cpp 
	${MKDIR} -p ${OBJECTDIR}/Libraries
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/LibJson.o Libraries/LibJson.cpp

${OBJECTDIR}/Libraries/LibSocket.o: Libraries/LibSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/Libraries
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/LibSocket.o Libraries/LibSocket.cpp

${OBJECTDIR}/Libraries/LibSpi.o: Libraries/LibSpi.cpp 
	${MKDIR} -p ${OBJECTDIR}/Libraries
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/LibSpi.o Libraries/LibSpi.cpp

${OBJECTDIR}/Libraries/LibStr.o: Libraries/LibStr.cpp 
	${MKDIR} -p ${OBJECTDIR}/Libraries
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/LibStr.o Libraries/LibStr.cpp

${OBJECTDIR}/Model/Board.o: Model/Board.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/Board.o Model/Board.cpp

${OBJECTDIR}/Model/HummingBoardI2Ex.o: Model/HummingBoardI2Ex.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/HummingBoardI2Ex.o Model/HummingBoardI2Ex.cpp

${OBJECTDIR}/Model/IntelEdison.o: Model/IntelEdison.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/IntelEdison.o Model/IntelEdison.cpp

${OBJECTDIR}/Model/IntelGalileo.o: Model/IntelGalileo.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/IntelGalileo.o Model/IntelGalileo.cpp

${OBJECTDIR}/Model/Pin.o: Model/Pin.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/Pin.o Model/Pin.cpp

${OBJECTDIR}/Model/RaspberryPi.o: Model/RaspberryPi.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/RaspberryPi.o Model/RaspberryPi.cpp

${OBJECTDIR}/Model/jsonObject.o: Model/jsonObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Model
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model/jsonObject.o Model/jsonObject.cpp

${OBJECTDIR}/Modules/ArduinoADC.o: Modules/ArduinoADC.cpp 
	${MKDIR} -p ${OBJECTDIR}/Modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/ArduinoADC.o Modules/ArduinoADC.cpp

${OBJECTDIR}/Modules/ArduinoUltraSonic.o: Modules/ArduinoUltraSonic.cpp 
	${MKDIR} -p ${OBJECTDIR}/Modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/ArduinoUltraSonic.o Modules/ArduinoUltraSonic.cpp

${OBJECTDIR}/Modules/Blink.o: Modules/Blink.cpp 
	${MKDIR} -p ${OBJECTDIR}/Modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/Blink.o Modules/Blink.cpp

${OBJECTDIR}/Socket/PracticalSocket.o: Socket/PracticalSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/Socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Socket/PracticalSocket.o Socket/PracticalSocket.cpp

${OBJECTDIR}/Socket/ServerSocket.o: Socket/ServerSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/Socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Socket/ServerSocket.o Socket/ServerSocket.cpp

${OBJECTDIR}/Socket/clientSocket.o: Socket/clientSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/Socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Socket/clientSocket.o Socket/clientSocket.cpp
